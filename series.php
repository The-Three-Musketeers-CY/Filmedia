...
<?php
    ...
    foreach ($trends as $trend) {
        ...
        if (isset($trend->poster_path)) {
            echo "\t\t<img src=\"https://image.tmdb.org/t/p/w185" . $trend->poster_path . "\" alt=\"Affiche de " . htmlspecialchars($trend->name) . "\"/>\n";
        } else {
            echo "\t\t<img src=\"./img/no-image.svg\" width=\"185\" alt=\"no image\"/>\n";
        }
        echo "\t\t<div class=\"info\">\n";
        echo "\t\t\t<h3>" . htmlspecialchars($trend->name) . "</h3>\n";
    ...
    foreach ($genres as $genre) {
        ...
        foreach($series as $serie){
            ...
            if (isset($serie->poster_path)) {
                echo "\t\t<img src=\"https://image.tmdb.org/t/p/w185" . $serie->poster_path . "\" alt=\"Affiche de " . htmlspecialchars($serie->name) . "\"/>\n";
            } else {
                echo "\t\t<img src=\"./img/no-image.svg\" width=\"185\" alt=\"no image\"/>\n";
            }
            echo "\t\t<div class=\"info\">\n";
            echo "\t\t\t<h3>" . htmlspecialchars($serie->name) . "</h3>\n";
