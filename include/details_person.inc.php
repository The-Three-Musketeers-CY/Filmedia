...
<main>
        ...
        <section id="details">
            <img src="<?php echo $src; ?>" width="300" alt="Affiche de <?php echo htmlspecialchars($media->name); ?>"/>
            <div id="details-info">
                <div id="details-info-title">
                    <h2><?php echo htmlspecialchars($media->name); ?></h2>
<?php
...
?>               
                ...
                <div id="details-info-description">
                    <p><?php echo htmlspecialchars($media->biography); ?></p>
<?php
...
<?php
    ...
    foreach ($credits as $credit) {
        if ($credit->media_type == "movie") {
            $title = htmlspecialchars($credit->title);
            $date = $credit->release_date;
        } else {
            $title = htmlspecialchars($credit->name);
